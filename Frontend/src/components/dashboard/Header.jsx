    ...
    <header className="bg-white p-4 flex justify-between items-center border-b border-gray-200">
      <div className="hidden md:flex items-center space-x-4  md:w-1/3">
        ...
        <div className="flex items-center flex-1">
          ...
          <input type="text" placeholder="Search your course..." className="flex-1 py-1 text-sm focus:outline-none ml-2" />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-[#333333]">Jason Ranti</span>
